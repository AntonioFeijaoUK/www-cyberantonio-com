...
<style>
  body {
      background-image: url("/assets/images/background/philipp-katzenberger-jVx8JaO2Ddc-unsplash.jpg");
...
<div class="hero-text">
    ...
    <h2>This is a personal website with study notes<br>
    My opinions are my own</h2>
